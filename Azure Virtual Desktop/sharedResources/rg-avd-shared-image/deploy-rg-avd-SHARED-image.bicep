...
resource rg_avd_shared_image_regioncode_environmentType 'Microsoft.Resources/resourceGroups@2022-09-01' = {
  name: 'rg-avd-shared-image-${locationCode}-${environmentType}'
  location: location
  tags: {
    Billing: tagsBilling
...
output rgSharedImageName string = rg_avd_shared_image_regioncode_environmentType.name
output rgSharedImageId string = rg_avd_shared_image_regioncode_environmentType.id
