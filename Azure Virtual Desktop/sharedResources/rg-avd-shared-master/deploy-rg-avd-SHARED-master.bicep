...
resource rg_avd_shared_master_regioncode_environmentType 'Microsoft.Resources/resourceGroups@2022-09-01' = {
  name: 'rg-avd-shared-master-${locationCode}-${environmentType}'
  location: location
  tags: {
    Billing: tagsBilling
...
output rgSharedMasterName string = rg_avd_shared_master_regioncode_environmentType.name
output rgSharedMasterId string = rg_avd_shared_master_regioncode_environmentType.id
