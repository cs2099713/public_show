...
resource rg_avd_shared_maintenance_regioncode_environmentType 'Microsoft.Resources/resourceGroups@2022-09-01' = {
  name: 'rg-avd-shared-maintenance-${locationCode}-${environmentType}'
  location: location
  tags: {
    Billing: tagsBilling
...
output rgSharedMaintenanceName string = rg_avd_shared_maintenance_regioncode_environmentType.name
output rgSharedMaintenanceId string = rg_avd_shared_maintenance_regioncode_environmentType.id
