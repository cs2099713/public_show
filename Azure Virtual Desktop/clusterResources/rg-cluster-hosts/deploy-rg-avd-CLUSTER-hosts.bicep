...
resource rg_avd_siteCode_appCode_hosts_regioncode_environmentType 'Microsoft.Resources/resourceGroups@2022-09-01' = {
  name: 'rg-avd-${siteCode}-${appCode}-hosts-${locationCode}-${environmentType}'
  location: location
  tags: {
    Billing: tagsBilling
...
output resourceGroupName string = rg_avd_siteCode_appCode_hosts_regioncode_environmentType.name
output resourceGroupID string = rg_avd_siteCode_appCode_hosts_regioncode_environmentType.id
